...
// Overloaded but couldnt get it to work
    /*
    public Drawable loadImage (ImageView view)
    {
        String url = (String) view.getTag();
        if (imageCache.containsKey(url))
        {
